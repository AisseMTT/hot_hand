...
```{r}
d_practice <- data.frame(SHOT_MADE_FLAG = c(1, 0, 0, 1, 1, 1, 1, 0, 1, 1))
...
d_practice2 <- populate_prev_shots(d_practice)
run_time <- proc.time() - start_time
run_time
d_practice2 %>% select(PLAYER_ID, GAME_ID, SHOT_MADE_FLAG, curr_hit_streak, curr_miss_streak) %>%
  View
```
